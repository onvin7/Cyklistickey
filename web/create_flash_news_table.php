...
try {
    ...
    echo "<h2>✅ Tabulka flash_news byla úspěšně vytvořena!</h2>";
    ...
    echo "<h2>✅ Ukázková data byla vložena!</h2>";
    echo "<h2>🎉 Flash News administrace je připravena k použití!</h2>";
    
    echo "<p><a href='/admin/flashnews'>Přejít na administraci Flash News</a></p>";
    
} catch (Exception $e) {
    echo "<h2>❌ Chyba: " . $e->getMessage() . "</h2>";
}
